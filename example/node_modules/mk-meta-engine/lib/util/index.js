...
exports.findPathByEvent = findPathByEvent;
...
(0, _assign2.default)(exports, (0, _extends3.default)({
    ...
    match: _path.match,
    isExpression: _expression.isExpression,
    getExpressionBody: _expression.getExpressionBody,
    stringToMoment: _trans.stringToMoment,
    momentToString: _trans.momentToString,
