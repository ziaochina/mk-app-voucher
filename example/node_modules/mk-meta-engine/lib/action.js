...
var _initialiseProps = function _initialiseProps() {
	...
	this.getFields = function (fieldPaths) {
		return util.getFields(_this.injections.getState(), fieldPaths);
	};
	...
	this.focus = function (e) {
		var path = util.findPathByEvent(e);
		if (_this.isFocus(path)) return;
	...
	this.findPathByEvent = util.findPathByEvent;
	this.stringToMoment = util.stringToMoment;
	this.momentToString = util.momentToString;
	this.fromJS = util.fromJS;
