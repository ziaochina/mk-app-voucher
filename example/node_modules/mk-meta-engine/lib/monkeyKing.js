        ...
        if (meta.component) {
            ...
            if (meta['_power'] && meta['_power'].indexOf('=>') != -1) {
                return function () {
                    ...
                    var co = metaToComponent((0, _extends3.default)({}, props.gm(meta.path + ',' + varsString), { _power: undefined }), props);
                    return co ? _react2.default.cloneElement(co, { path: meta.path + ',' + varsString }) : co;
                };
            }
